  ...
  function handleBubbles (layer, data, options ) {
    ...
    bubbles
      .enter()
        ...
        // keep initial radius for hover animation -DL
        ...
        .on('mouseover', function ( datum ) {
          ...
          if (options.highlightOnHover) {
            ...
            //shrink siblings on hover -DL
            d3.selectAll('.datamaps-bubble').filter(function(datum){return datum.city != id}).transition(100).attr('r', 5);
          }
        ...
        .on('mouseout', function ( datum ) {
          ...
          // enlarge siblings -DL
          d3.selectAll('.datamaps-bubble').filter(function(datum){return datum.city != id}).transition(100).attr('r', function(datum){return datum.radius});
