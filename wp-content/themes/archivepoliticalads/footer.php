<div id="footer" class="row">
    <div class="footer-section col-xs-12 col-lg-3 ">
    ...
    <div class="footer-section col-lg-offset-1 col-lg-4  hidden-xs">
        <?php get_sidebar( 'footer' ); ?>
    </div>
    <div id="footer-social-links" class="col-lg-offset-1 col-lg-3  col-xs-12">
        <ul>
