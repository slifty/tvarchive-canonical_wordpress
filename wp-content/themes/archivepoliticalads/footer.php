			...
			<div id="footer" class="row">
				...
				<div class="footer-section col-lg-offset-1 col-lg-3">
				...
				<div class="footer-section col-lg-offset-1 col-lg-2"></div>
				<div id="footer-social-links" class="footer-section col-lg-offset-1 col-lg-3">
					<ul>
