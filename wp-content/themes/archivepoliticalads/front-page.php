...
<div class="row">
    <div id="home-header-search">
        <div class="col-xs-12 col-md-6 col-md-offset-3 col-lg-6 col-lg-offset-3 home-header-search-formfield"><?php get_search_form(); ?></div>
    </div>
</div><!-- end searchr-->
...
<div id="home-feature-section"  class="row">
    ...
    <div   id="ad-embed_home" class="col-md-6 hidden-sm hidden-xs">
