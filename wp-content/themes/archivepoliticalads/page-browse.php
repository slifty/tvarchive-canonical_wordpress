...
<div id="browse-content" class="page-content">
    <?php
      ...
      if(array_key_exists('q', $_GET)) {
        ...
        ?>
        <div id="search-results-total" class="row"><?php echo(sizeof($archive_ids));?> Results Found</div>
        <?php
            ...
            foreach($posts as $post) {
              ...
              ?>
                <div class="political-ad" class="row">
                  <div class="embed col-lg-3"><iframe frameborder="0" allowfullscreen src="<?php echo($metadata['embed_url']);?>" webkitallowfullscreen="true" mozallowfullscreen="true"></iframe></div>
                  <div class="col-lg-9">
